...
export const Pokedex = () => {
  ...
  useEffect(() => {
    const pokemons: Pokemon[] = [
      ...
      { number: 45, name: 'Joliflor', types: ['Plante'] },
      ...
      { number: 63, name: 'Grolem', types: ['Roche', 'Glace'] },
      ...
      { number: 106, name: 'Lippoutou', types: ['Glace', 'Fée'] },
      { number: 107, name: 'Hexagel', types: ['Glace'] },
      ...
      { number: 130, name: 'Mouflair', types: ['Poison', 'Ténèbres'] },
